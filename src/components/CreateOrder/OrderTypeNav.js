          ...
          {orderTypes.map((type) => {
            ...
            return (
              <button
                ...
                className={`flex-1 px-4 py-4 cursor-pointer border-2 rounded-2xl transition-all flex items-center justify-center gap-2 font-semibold text-sm ${isActive ? type.activeClasses : type.idleClasses
                  }`}
              >
